...
var _user$project$Fonts$normalFont = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Fonts$headerFont = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$fontFamilies(
			{
...
var _user$project$Pizza$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'DiameterChanged') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{diameter: _p0._0});
		} else {
...
var _user$project$Pizza$area = function (diameter) {
	return _elm_lang$core$Basics$pi * Math.pow(diameter / 2, 2);
};
var _user$project$Pizza$pizzaValue = function (_p1) {
	var _p2 = _p1;
	var price_ = _elm_lang$core$String$toFloat(_p2.price);
	var diameter_ = _elm_lang$core$String$toFloat(_p2.diameter);
	var _p3 = {ctor: '_Tuple2', _0: diameter_, _1: price_};
	if (((_p3.ctor === '_Tuple2') && (_p3._0.ctor === 'Ok')) && (_p3._1.ctor === 'Ok')) {
		return _elm_lang$core$Maybe$Just(
			_user$project$Pizza$area(_p3._0._0) / _p3._1._0);
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Pizza$pizzaRatio = F2(
	function (p1, p2) {
		var v2 = _user$project$Pizza$pizzaValue(p2);
		var v1 = _user$project$Pizza$pizzaValue(p1);
		var _p4 = {ctor: '_Tuple2', _0: v1, _1: v2};
		if (_p4._0.ctor === 'Nothing') {
			...
			if (_p4._1.ctor === 'Nothing') {
				...
				return _elm_lang$core$Maybe$Just(
					A3(_elm_lang$core$Basics$clamp, 0.33, 3, _p4._0._0 / _p4._1._0));
			}
		}
	});
var _user$project$Pizza$init = {diameter: '', price: ''};
var _user$project$Pizza$Model = F2(
	function (a, b) {
		return {diameter: a, price: b};
	});
var _user$project$Pizza$PriceChanged = function (a) {
	return {ctor: 'PriceChanged', _0: a};
};
var _user$project$Pizza$DiameterChanged = function (a) {
	return {ctor: 'DiameterChanged', _0: a};
};
var _user$project$Pizza$view = function (model) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
							...
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Fonts$normalFont,
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Diameter'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text('Price'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(model.diameter),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(_user$project$Pizza$DiameterChanged),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
															{
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(model.price),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(_user$project$Pizza$PriceChanged),
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
																{
...
var _user$project$Main$githubLink = 'https://github.com/mlevesquedion';
var _user$project$Main$viewFooter = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('Made by '),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(_user$project$Main$githubLink),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
									{
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('@mlevesquedion'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text(', for the love of pizza'),
						_1: {ctor: '[]'}
					}
				}
			}),
			...
			_0: A2(
				_rtfeldman$elm_css$Html_Styled$a,
				{
					...
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(
						A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$githubLink, '/piscale')),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('gh_logo.png'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
									{
...
var _user$project$Main$backgroundColor_ = _rtfeldman$elm_css$Css$hex('FFFFFF');
var _user$project$Main$italianGreen = _rtfeldman$elm_css$Css$hex('026334');
var _user$project$Main$italianRed = _rtfeldman$elm_css$Css$hex('A50B31');
var _user$project$Main$coloredBar = function (color_) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$backgroundColor(color_),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(color_),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$width(
								_rtfeldman$elm_css$Css$pct(100)),
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('_'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$pizzaImg = function (ratio) {
	var factor = 1.2;
	return A2(
		_rtfeldman$elm_css$Html_Styled$img,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$src('pizza.png'),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$width(
							_rtfeldman$elm_css$Css$px(ratio * factor)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
								_rtfeldman$elm_css$Css$px(ratio * factor)),
							_1: {
								...
								_0: _rtfeldman$elm_css$Css_Transitions$transition(
									{
										ctor: '::',
										_0: A3(_rtfeldman$elm_css$Css_Transitions$width3, 200, 0, _rtfeldman$elm_css$Css_Transitions$easeInOut),
										_1: {
											ctor: '::',
											_0: A3(_rtfeldman$elm_css$Css_Transitions$height3, 200, 0, _rtfeldman$elm_css$Css_Transitions$easeInOut),
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
...
var _user$project$Main$viewDeal = function (deal) {
	var _p0 = deal;
	if (_p0.ctor === 'Nothing') {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
				...
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$h2,
					{
						...
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
							{
								ctor: '::',
								_0: _user$project$Fonts$headerFont,
								_1: {
									ctor: '::',
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Fill in the fields below to find the best pizza deal!'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
		...
		if (_p1.ctor === 'Left') {
			return A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$pizzaImg(_p1._0),
					_1: {
						ctor: '::',
						_0: _user$project$Main$pizzaImg(100.0),
						_1: {ctor: '[]'}
					}
				});
		} else {
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {left: a, right: b, deal: c};
	});
var _user$project$Main$init = A3(_user$project$Main$Model, _user$project$Pizza$init, _user$project$Pizza$init, _elm_lang$core$Maybe$Nothing);
var _user$project$Main$R = {ctor: 'R'};
var _user$project$Main$L = {ctor: 'L'};
...
var _user$project$Main$calculateDeal = F2(
	function (left, right) {
		var ratio = A2(_user$project$Pizza$pizzaRatio, left, right);
		var _p2 = ratio;
		if (_p2.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			var _p3 = _p2._0;
			return (_elm_lang$core$Native_Utils.cmp(_p3, 1) > 0) ? _elm_lang$core$Maybe$Just(
				_user$project$Main$Left(_p3 * 100)) : _elm_lang$core$Maybe$Just(
				_user$project$Main$Right((1 / _p3) * 100));
		}
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p4 = msg;
		if (_p4._0.ctor === 'L') {
			var newLeft = A2(_user$project$Pizza$update, _p4._1, model.left);
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					left: newLeft,
					deal: A2(_user$project$Main$calculateDeal, newLeft, model.right)
				});
		} else {
			var newRight = A2(_user$project$Pizza$update, _p4._1, model.right);
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					right: newRight,
					deal: A2(_user$project$Main$calculateDeal, model.left, newRight)
				});
		}
	});
var _user$project$Main$PizzaMsg = F2(
	function (a, b) {
		return {ctor: 'PizzaMsg', _0: a, _1: b};
	});
	...
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			...
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Main$backgroundColor_),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
									...
									_1: {
										...
										_1: {
											...
											_0: A4(
												...
												_rtfeldman$elm_css$Css$px(0),
												_rtfeldman$elm_css$Css$px(5),
												_rtfeldman$elm_css$Css$hex('F4AF27')),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text('PiScale'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$coloredBar(_user$project$Main$italianRed),
				_1: {
					ctor: '::',
					_0: _user$project$Main$coloredBar(_user$project$Main$italianGreen),
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewDeal(model.deal),
						_1: {
							ctor: '::',
							_0: A2(
								_rtfeldman$elm_css$Html_Styled$div,
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												_user$project$Main$PizzaMsg(_user$project$Main$L),
												_user$project$Pizza$view(model.left)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_rtfeldman$elm_css$Html_Styled$map,
													_user$project$Main$PizzaMsg(_user$project$Main$R),
													_user$project$Pizza$view(model.right)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
